...
content_server=$content_server'    ssl_certificate      "/app/cert.crt";\n'
content_server=$content_server'    ssl_certificate_key     "/app/key.key";\n'
content_server=$content_server'    ssl_protocols       TLSv1 TLSv1.1 TLSv1.2;\n'
content_server=$content_server'    ssl_ciphers         "EECDH+AESGCM:EDH+AESGCM:AES256+EECDH:AES256+EDH";\n'
content_server=$content_server'    location / {\n'
content_server=$content_server'        include uwsgi_params;\n'
content_server=$content_server'        uwsgi_pass unix:///tmp/uwsgi.sock;\n'
content_server=$content_server'    }\n'
